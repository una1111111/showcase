  ...
  return (
    <div className="anim-page mx-auto w-full max-w-3xl px-5 pb-28 pt-28 sm:px-10 sm:pt-36">
      ...
      <div className="mt-2 flex flex-col gap-4 rounded-3xl border-2 border-ink/10 bg-white/75 p-6 text-[15px] leading-8 text-ink/75 shadow-sticker sm:p-8 sm:leading-9">
        ...
        <p>
          从几百组家庭撒欢的青少年定向赛，到 Nike、NCAA 的品牌现场，再到一座城市夏天的市级足球联赛和省级文化推广项目——
          我完整走过了一场活动从市场洞察、策略制定、多方统筹到数据复盘的每一步。最上头的时刻，就是看着自己排的时间表变成眼前真的在发生的热闹；
          而最有成就感的，是看到这些热闹最终转化为实打实的业务数据。
        </p>
        <p>
          我习惯把每场活动当成一次产品迭代：先盘清目标与人群，拉齐资源与排期，结束后一定留下可复用的
          SOP 与模板。日常我也是 AIGC 工具的重度玩家，曾主动搭建 AI Agent 实现数据自动采集与实时计分。我坚信
